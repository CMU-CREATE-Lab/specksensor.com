...
/**
 * Creates an instance of a <code>RemoteError</code> containing the given <code>jSendResponse</code> object.  The given
 * <code>jSendResponse</code> will be stored in this instance's <code>data</code> property.
 *
 * @param {object} jSendResponse The JSend response which will be used to create this instance.
 * @constructor
 */
function RemoteError(jSendResponse) {
   this.constructor.prototype.__proto__ = Error.prototype;
   Error.captureStackTrace(this, this.constructor);
   this.name = this.constructor.name;
   this.data = jSendResponse;
   this.message = "Remote Error";
}

module.exports.DatabaseError = DatabaseError;
module.exports.DuplicateRecordError = DuplicateRecordError;
module.exports.ValidationError = ValidationError;
module.exports.RemoteError = RemoteError;